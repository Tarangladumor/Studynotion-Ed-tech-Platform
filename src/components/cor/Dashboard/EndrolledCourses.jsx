...
const EndrolledCourses = () => {
  ...
  const [endrolledCourses, setEndrolledCourses] = useState(null);

  const getEndrolledCourses = async () => {
    try {
      const response = await getUserEnrolledCourses(token);
      setEndrolledCourses(response);
    } catch (error) {
      console.log("Unable to fetch endrolled courses")
    }
  }
  ...
  console.log("ENDROLLED COURSES.................", endrolledCourses);
    ...
    <>
      ...
      {!endrolledCourses ? (
        ...
        <div className="my-8 text-richblack-5">
          ...
          {/* Course Names */}
          {endrolledCourses.map((course, i, arr) => (
            <div
