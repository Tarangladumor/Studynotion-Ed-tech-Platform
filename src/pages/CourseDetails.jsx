...
import CourseDetailsCard from '../components/cor/course/CourseDetailsCard';
import { BiInfoCircle } from 'react-icons/bi';
import { HiOutlineGlobeAlt } from 'react-icons/hi'
import Footer from '../components/common/Footer';
import CourseAccordionBar from '../components/cor/course/CourseAccordionBar';
...
const CourseDetails = () => {
    ...
    useEffect(() => {
        const getCourseDetails = async () => {
            try {
                ...
                console.log("Could not fetch vourse Details", error);
            }
        }
    ...
    const [totalNoOfLectures, setTotalNumberOfLectures] = useState(0);
    ...
    console.log("HIIIIIIIIIIIIIIIIIII", courseData)
                    ...
                    <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
                        ...
                        >
                            ...
                            <div className="text-md flex flex-wrap items-center gap-2">
                                ...
                                <span>{`${studentEndrolled.length} students enrolled`}</span>
                            </div>
                            <div>
                                <p className="">
